											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														<?php
														$sql2 = "SELECT id from agency ";
														$query2 = $dbh->prepare($sql2);
														$query2->execute();
														$results2 = $query2->fetchAll(PDO::FETCH_OBJ);
														$reg_agenncies = $query2->rowCount();
														?>

														<div class="stat-panel-number h1 "><?php echo $reg_agenncies; ?></div>
														<div class="stat-panel-title text-uppercase">Reg Agencies</div>
													</div>
												</div>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														<?php
														$sql1 = "SELECT id from tbcars ";
														$query1 = $dbh->prepare($sql1);;
														$query1->execute();
														$results1 = $query1->fetchAll(PDO::FETCH_OBJ);
														$totalcars = $query1->rowCount();
														?>
														<div class="stat-panel-number h1 "><?php echo $totalcars; ?></div>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														<?php
														$sql2 = "SELECT id from pending_booking ";
														$query2 = $dbh->prepare($sql2);
														$query2->execute();
														$results2 = $query2->fetchAll(PDO::FETCH_OBJ);
														$p_bookings = $query2->rowCount();
														?>

														<div class="stat-panel-number h1 "><?php echo $p_bookings; ?></div>
